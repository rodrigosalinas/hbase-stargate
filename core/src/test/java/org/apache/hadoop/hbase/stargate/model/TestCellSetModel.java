...
public class TestCellSetModel extends TestCase {
  ...
  static final byte[] ROW2 = Bytes.toBytes("testrow1");
  static final byte[] COLUMN2 = Bytes.toBytes("testcolumn2");
  static final byte[] VALUE2 = Bytes.toBytes("testvalue2");
  static final long TIMESTAMP2 = 1245239813319L;
  static final byte[] COLUMN3 = Bytes.toBytes("testcolumn3");
  static final byte[] VALUE3 = Bytes.toBytes("testvalue3");
  static final long TIMESTAMP3 = 1245393318192L;
  ...
  CellSetModel fromXML(String xml) throws JAXBException {
    return (CellSetModel)
  ...
  CellSetModel fromPB(String pb) throws IOException {
    return (CellSetModel) 
      new CellSetModel().getObjectFromMessage(Base64.decode(AS_PB));
  }

  void checkModel(CellSetModel model) {
