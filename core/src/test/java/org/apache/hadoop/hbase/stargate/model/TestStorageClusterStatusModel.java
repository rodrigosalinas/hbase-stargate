...
"AAAA8D8=";
  ...
  StorageClusterStatusModel buildTestModel() {
  ...
  String toXML(StorageClusterStatusModel model) throws JAXBException {
    StringWriter writer = new StringWriter();
    context.createMarshaller().marshal(model, writer);
    return writer.toString();
  }

  StorageClusterStatusModel fromXML(String xml) throws JAXBException {
    return (StorageClusterStatusModel)
      context.createUnmarshaller().unmarshal(new StringReader(xml));
  }

  byte[] toPB(StorageClusterStatusModel model) {
    return model.createProtobufOutput();
  }

  StorageClusterStatusModel fromPB(String pb) throws IOException {
    return (StorageClusterStatusModel) 
      new StorageClusterStatusModel().getObjectFromMessage(Base64.decode(AS_PB));
  }

  void checkModel(StorageClusterStatusModel model) {
  ...
  public void testStorageClusterStatusModel() throws Exception {
