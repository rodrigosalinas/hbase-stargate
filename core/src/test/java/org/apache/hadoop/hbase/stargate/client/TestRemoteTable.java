...
public class TestRemoteTable extends MiniClusterTestBase {
  ...
  void doTestPut() throws IOException {
  ...
  void doTestDelete() throws IOException {
    Put put = new Put(ROW_3);
    put.add(COLUMN_1, QUALIFIER_1, VALUE_1);
    put.add(COLUMN_2, QUALIFIER_2, VALUE_2);
    remoteTable.put(put);
  ...
  void doTestScanner() throws IOException {
    List<Put> puts = new ArrayList<Put>();
  ...
  public void testRemoteTable() throws Exception {
    doTestGetTableDescriptor();
    doTestGet();
    doTestPut();
    doTestDelete();
    doTestScanner();
