...
public class TestJDBCAuthenticator extends TestCase {
  ...
  JDBCAuthenticator authenticator;
  ...
  void doTestGetUserUnknown() throws Exception {
    User user = authenticator.getUserForToken(UNKNOWN_TOKEN);
    assertNull(user);
  }

  void doTestGetAdminUser() throws Exception {
  ...
  void doTestGetPlainUser() throws Exception {
  ...
  void doTestGetDisabledUser() throws Exception {
  ...
  public void testJDBCAuthenticator() throws Exception {
    doTestGetUserUnknown();
    doTestGetAdminUser();
    doTestGetPlainUser();
    doTestGetDisabledUser();
  }
}
