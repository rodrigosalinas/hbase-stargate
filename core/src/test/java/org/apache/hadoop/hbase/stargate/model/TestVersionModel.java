...
public class TestVersionModel extends TestCase {
  static final String STARGATE_VERSION = "0.0.1";
  static final String OS_VERSION = 
    "Linux 2.6.18-128.1.6.el5.centos.plusxen amd64";
  static final String JVM_VERSION = "Sun Microsystems Inc. 1.6.0_13-11.3-b02";
  static final String JETTY_VERSION = "6.1.14";
  static final String JERSEY_VERSION = "1.1.0-ea";
  ...
  VersionModel fromXML(String xml) throws JAXBException {
    return (VersionModel)
  ...
  VersionModel fromPB(String pb) throws IOException {
    return (VersionModel) 
  ...
  public void testVersionModel() throws Exception {
